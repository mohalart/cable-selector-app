...
# COMPLETELY REMOVE LOCALE CODE - This was causing the error
# import locale  # Remove this entirely
...
def show_log_window(log_content):
    ...
    close_button = ttk.Button(log_main_frame, text="Close", command=log_window.destroy,
                              style="success.TButton")
    close_button.pack(pady=(10, 0))
